 ...
 * 
 */
public class RedMummy extends BasePersonSpite {

	@Override
	public void execute() {
		clearEntityModifiers();
		registerEntityModifier(new LoopEntityModifier(new DelayModifier(13,
	...
	public RedMummy(float pX, float pY,
			VertexBufferObjectManager vertexBufferObjectManager) {
		super(pX, pY, GameData.getInstance().redMummyTextureRegion,
