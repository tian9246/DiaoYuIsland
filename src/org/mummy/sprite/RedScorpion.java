...
public class RedScorpion extends BasePersonSpite {

	@Override
	public void execute() {
		clearEntityModifiers();
		registerEntityModifier(new LoopEntityModifier(new DelayModifier(12,
	...
	public RedScorpion(float pX, float pY,
			VertexBufferObjectManager vertexBufferObjectManager) {
		super(pX, pY, GameData.getInstance().redScorpionTextureRegion,
